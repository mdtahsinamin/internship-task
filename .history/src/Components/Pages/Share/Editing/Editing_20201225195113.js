...
const Editing = () => {
    ...
    const exact = id.split(' ');
    
    const orderId = exact[0];
    const orderIndex = exact[1];
    ...
    return (
     <section className='container'>
            <div className='d-flex mt-5 editing-Panel-1'>
                <div>
                   <h5>Editing Panel</h5>
                ...
                <div>
                  ...
                  (different.add && !different.update && !different.delete) &&    <AddNew></AddNew>
                  
                  }
                  {
                  
                   (!different.add && different.update && !different.delete) 
                     && <Update orderId={orderId}></Update>
                  
                  }
                  {
                  
                  (!different.add && !different.update && different.delete)
                   && <Delete orderId={orderId} orderIndex={orderIndex}></Delete>   
