           ...
           <Container>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="ml-auto">
                   ...
                   <Link className="mr-5 mt-2" to='/home' style={linkStyle}>{links[1]}</Link>
                   <Link className="mr-5 mt-2" to='/home' style={linkStyle}>{links[2]}</Link>
...
/*
{
                        links.map((link,index) =>{
                              return (
                               <Link className="mr-5 mt-2" to={`${link.toLocaleLowerCase().split(' ').join('-')}`} style={linkStyle} key={index}>
                                   {link}
                               </Link>
                              )
                        })
